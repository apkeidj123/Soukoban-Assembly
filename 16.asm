...
.data
	...
	clearname byte "                                                                                 ",0
	namebgm1 byte "Tetris Type A - Super Smash Bros. Brawl",0
	namebgm2 byte "Soldier of Dance - Team Fortress 2 Soundtrack",0
	namebgm3 byte "our hearts collide - iamsleepless",0
	namebgm4 byte "Unity - TheFatRat",0
	namebgm5 byte "A Tale of Six Trillion Years and a Night - U~ingu",0
